...
export class AddEditDoctorComponent {
  ...
  public onSaveClick(): void {
    ...
    const activityObj: Record<string, any> = {
      Name: this.dialogState === 'new' ? 'Added New Teacher' : 'Updated Teacher',
      Message: `Prof.${obj['Name']}, ${obj['Specialization'].charAt(0).toUpperCase() + obj['Specialization'].slice(1)}`,
      Time: '10 mins ago',
      Type: 'teacher',
