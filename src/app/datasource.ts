...
export const doctorsData: Record<string, any>[] = [
    ...
    },
    {
        ...
        DepartmentId: 5,
        Color: '#df5286',
        Education: 'Engineering, M.S',
        Designation: 'Junior Practicle Attender',
        Specialization: 'Engg. Workshop',
        Experience: '1+ years',
        DutyTiming: 'Shift2',
...
export const hospitalData: Record<string, any>[] = [
    {
        ...
        DoctorId: 5,
        PatientId: 2,
        // Subject: 'Swelling or bruising over a bone, Pain in the injured area'
    }, {
        Id: 1001,
        Name: 'Janet',
        StartTime: new Date(2020, 7, 3, 11, 0),
...
export const specializationData: Record<string, any>[] = [
    { DepartmentId: 1, Id: 'computers', Text: 'Computer Science', Color: '#F538B2' },
    { DepartmentId: 2, Id: 'electronics', Text: 'Electronics', Color: '#33C7E8' },
    { DepartmentId: 3, Id: 'electrical', Text: 'Electrical', Color: '#916DE4' },
    { DepartmentId: 4, Id: 'fire', Text: 'Fire', Color: '#388CF5' },
    { DepartmentId: 5, Id: 'civil', Text: 'Civil', Color: '#60F238' },
    { DepartmentId: 6, Id: 'mechanical', Text: 'Mechanical', Color: '#F29438' }
];
...
export const activityData: Record<string, any>[] = [
    {
        Name: 'Added New Teacher',
        Message: 'Dr.Johnson James, M.Tech',
        Time: '5 mins ago',
        Type: 'teacher',
    ...
    },
    {
        ...
        Message: 'Laura for attending class on 7th September, 2020 @ 8.30 AM with Prof. Molli Cobb',
        Time: '5 mins ago',
        Type: 'appointment',
        ActivityTime: new Date(2020, 7, 8, 11, 0)
    },
    {
        Name: 'Added New Student',
        Message: 'James Richard for attending class',
        Time: '5 mins ago',
        Type: 'student',
    ...
    {
        Name: 'Added New Appointment',
        Message: 'Joseph for attending class on 7th December, 2020 @ 11.10 AM with Prof. Molli Cobb',
        Time: '5 mins ago',
        Type: 'appointment',
